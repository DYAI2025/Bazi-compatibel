  ...
  return (
    <div className="min-h-screen bg-zinc-950 p-6 md:p-10 text-zinc-100 font-sans">
      ...
      <div className="overflow-x-auto w-full max-w-4xl mx-auto bg-zinc-900 p-4 sm:p-6 rounded-2xl border border-zinc-800 shadow-2xl scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-zinc-900">
        ...
        <div className="mt-12 p-8 bg-zinc-900 rounded-2xl border border-zinc-800 text-center">
          <h3 className="text-2xl font-serif italic text-amber-500 mb-4">
            {lang === 'de' ? 'Die Tiefe beginnt mit deinem Profil.' : 'The depth begins with your profile.'}
          </h3>
          <p className="text-zinc-300 mb-6 text-sm leading-relaxed max-w-lg mx-auto">
            {lang === 'de' 
              ? 'Die Matrix zeigt dir den schnellen Einstieg: dein Zeichen und erste Kompatibilitäten. Wenn du wirklich verstehen willst, wie du Beziehungen erlebst, welche Muster dich prägen und warum bestimmte Menschen dich besonders anziehen oder triggern, brauchst du mehr als nur dein Zeichen.'
